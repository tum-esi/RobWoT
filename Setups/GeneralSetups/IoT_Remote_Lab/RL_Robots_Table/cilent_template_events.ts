...
const sensor1 = JSON.parse(readFileSync("../../../TDs/Virtual/virtual_infrared_sensor1.td.json","utf-8"));
const sensor2 = JSON.parse(readFileSync("../../../TDs/Virtual/virtual_infrared_sensor2.td.json","utf-8"));
const conveyor1 = JSON.parse(readFileSync("../../../TDs/Virtual/virtual_conveyor_left.td.json","utf-8"));
const conveyor2 = JSON.parse(readFileSync("../../../TDs/Virtual/virtual_conveyor_right.td.json","utf-8"));

const colorSensor = JSON.parse(readFileSync("../../../TDs/Virtual/virtual_color_sensor.td.json","utf-8"));
const dobot = JSON.parse(readFileSync("../../../TDs/Virtual/virtual_dobot.td.json","utf-8"));
const uarm = JSON.parse(readFileSync("../../../TDs/Virtual/virtual_uarm.td.json","utf-8"));
main()
