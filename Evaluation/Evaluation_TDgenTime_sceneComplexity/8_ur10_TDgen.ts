...
async function robotTDGen() {
    ...
    let dtSceneAddress = rootAddress + "/Evaluation_TDgenTime_sceneComplexity/8_ur10_scene.ttt";
    ...
    let rootFolderPath = rootAddress + "/Evaluation_TDgenTime_sceneComplexity/robot_info/ur10_robot"; //the path of folder to save necessary files
