...
async function robotTDGen() {
    ...
    let dtSceneAddress = rootAddress + "/Evaluation_TDgenTime_sceneComplexity/6_m1pro_scene.ttt";
    ...
    let rootFolderPath = rootAddress + "/Evaluation_TDgenTime_sceneComplexity/robot_info/m1pro_robot"; //the path of folder to save necessary files
    ...
    let optionsm1pro = {
        ...
        "stlFilepath": "http://localhost:4000/m1pro_robot/m1pro_robot_shape.stl",
        "csvFilepath": "http://localhost:4000/m1pro_robot/m1pro_robot_data_point.csv",
        "sceneFilepath": "http://localhost:4000/m1pro_robot/m1pro_robot.ttm",
        "href":"http://localhost:8081/",
        "port": 8081
    }

    // generate TD file base on robot name and necessary files in folder
    await rdg.generateTD(robotName, rootFolderPath,optionsm1pro);  
}
